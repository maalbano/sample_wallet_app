...
class AppRoutes {
  ...
  static const String SEND_MONEY_ROUTE_NAME = 'send_money';
  static const String SEND_MONEY_ROUTE_PATH = '/send_money';

  static const String VIEW_TRANSACTIONS_ROUTE_NAME = 'view_transactions';
  static const String VIEW_TRANSACTIONS_ROUTE_PATH = '/view_transactions';
}
