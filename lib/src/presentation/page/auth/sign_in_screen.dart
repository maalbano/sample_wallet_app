...
import 'package:sample_wallet_app/src/comman/enum.dart';
import 'package:sample_wallet_app/src/comman/routes.dart';
import 'package:sample_wallet_app/src/comman/toast.dart';
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SignInFormBloc, SignInFormState>(
      ...
      builder: (context, state) {
        final isLoading = state is SignInFormLoading;
        return Scaffold(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text((state is SignInFormFailure) ? state.error : ''),
                      //   const SizedBox(height: SPACE25),
